...
public class Row
{
    ...
    {
        return "ClassPojo [OPERATION_RULE_NM = "+OPERATION_RULE_NM+", BUS_ADD_RATES = "+BUS_ADD_RATES+", PARKING_TYPE_NM = "+PARKING_TYPE_NM+", CAPACITY = "+CAPACITY+", WEEKEND_END_TIME = "+WEEKEND_END_TIME+", WEEKDAY_END_TIME = "+WEEKDAY_END_TIME+", PAY_NM = "+PAY_NM+", ASSIGN_CODE_NM = "+ASSIGN_CODE_NM+", ADD_RATES = "+ADD_RATES+", ADD_TIME_RATE = "+ADD_TIME_RATE+", TEL = "+TEL+", PARKING_CODE = "+PARKING_CODE+", WORK_DTTM = "+WORK_DTTM+", PARKING_NAME = "+PARKING_NAME+", ADDR = "+ADDR+", SATURDAY_PAY_NM = "+SATURDAY_PAY_NM+", DAY_MAXIMUM = "+DAY_MAXIMUM+", HOLIDAY_END_TIME = "+HOLIDAY_END_TIME+", HOLIDAY_PAY_NM = "+HOLIDAY_PAY_NM+", WEEKEND_BEGIN_TIME = "+WEEKEND_BEGIN_TIME+", LNG = "+LNG+", FULLTIME_MONTHLY = "+FULLTIME_MONTHLY+", LAT = "+LAT+", HOLIDAY_BEGIN_TIME = "+HOLIDAY_BEGIN_TIME+", TIME_RATE = "+TIME_RATE+", WEEKDAY_BEGIN_TIME = "+WEEKDAY_BEGIN_TIME+", RATES = "+RATES+", NIGHT_FREE_OPEN_NM = "+NIGHT_FREE_OPEN_NM+", BUS_RATES = "+BUS_RATES+", BUS_TIME_RATE = "+BUS_TIME_RATE+", GRP_PARKNM = "+GRP_PARKNM+", BUS_ADD_TIME_RATE = "+BUS_ADD_TIME_RATE+"]";
    }
}